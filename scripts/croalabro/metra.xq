(: CroALaBro index auctorum, operum, generum, temporum, metrorum :)
...
declare variable $title := 'Croatiae auctores Latini: index metrorum';
...
declare variable $content := "Display list of verse meters in CroALa.";
declare variable $keywords := "Neo-Latin, Croatia, text corpus, meter, versification";
...
{ croalabro-html:table (("Metrum", "Quot carmina" ), croalabro:tabulametrorum()) }
</div>
</div>
